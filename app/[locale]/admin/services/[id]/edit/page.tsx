...
import { getService, updateService, deleteService } from '@/lib/firebase/firestore';
...
export default function EditServicePage({ params }: { params: { locale: string; id: string } }) {
  ...
  }, [user, authLoading, isAdmin, params.id]);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-4xl font-serif font-bold text-platinum-900 mb-2">Edit Service</h1>
              <div className="w-16 h-px bg-platinum-400" />
            </div>
            <button
              onClick={handleDelete}
              disabled={deleting}
              className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
                ...
                >
                  {uploading ? (
                    ...
                    <>
                      ...
                      <span className="text-platinum-700 font-medium">Upload New Image</span>
                    </>
                  )}
                </button>
