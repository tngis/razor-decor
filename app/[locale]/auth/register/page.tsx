...
import { UserPlus, Smartphone, Lock, ArrowRight } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleVerifyCode = async (e: React.FormEvent) => {
    ...
    try {
      await verifyCode(verificationCode, pin, true);
        ...
        <div className="card-premium p-10">
          ...
          {step === 'phone' ? (
            ...
            <form onSubmit={handleVerifyCode} className="space-y-6">
              <div>
                <label className="text-sm font-semibold text-platinum-700 mb-2 text-center block">
                  {t('smsCode')}
                </label>
